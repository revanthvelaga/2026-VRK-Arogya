...
// Same OAuth client as the customer site; leave VITE_GOOGLE_CLIENT_ID
// unset and the Google button simply doesn't show.
...
// with the ID token once the person picks an account. The backend
