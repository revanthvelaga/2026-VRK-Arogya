...
export function WelcomeSplash() {
  const { welcome, clearWelcome, user } = useAuth();
  ...
  const greeting = `Welcome back${pretty ? `, ${pretty}` : ''}`;
  const tagline = user?.role === 'STAFF' ? 'Ready for today’s collections' : 'Your lab, running smoothly';
  ...
  return (
    ...
    >
      ...
      <div className="wow-center">
        ...
        <div className="wow-tagline">{tagline}</div>
      </div>
